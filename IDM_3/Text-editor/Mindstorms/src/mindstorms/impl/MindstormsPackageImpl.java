...
public class MindstormsPackageImpl extends EPackageImpl implements MindstormsPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRotate_Random(), ecorePackage.getEBoolean(), "random", "false", 0, 1, Rotate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
