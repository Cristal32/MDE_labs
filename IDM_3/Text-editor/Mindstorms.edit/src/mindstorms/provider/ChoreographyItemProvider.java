	...
	protected void addInstructionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Choreography_instructions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Choreography_instructions_feature", "_UI_Choreography_type"),
