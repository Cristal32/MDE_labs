...
public class SQLAdapterFactory extends AdapterFactoryImpl {
	...
	protected SQLSwitch<Adapter> modelSwitch =
		new SQLSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNamedElmt(NamedElmt object) {
				return createNamedElmtAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link SQL.DB <em>DB</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link SQL.NamedElmt <em>Named Elmt</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNamedElmtAdapter() {
		return null;
	}
